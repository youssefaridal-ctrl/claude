...
const CHAPTERS: Record<string, { heading: string; body: string }[]> = {
  ...
  rania: [
    { heading: "قبل", body: "كانت هناك قائمة. قائمة في قائمة. لكل مشروع طوّقته بـ'لاحقاً'، كان هناك اجتماع قلت فيه 'نحتاج إلى مزيد من الوقت.' ما لم أقله: إنني لم أكن أحتاج وقتاً. كنت أحتاج أن يكون الشيء كاملاً قبل أن يراه أحد. والكمال، اكتشفت لاحقاً، أفق متراجع." },
    { heading: "التحوّل", body: "التشخيص جاء مع جملة واحدة قرأتها في الثانية بعد منتصف الليل: 'الكمالية ليست معياراً عالياً — إنها إدارة الخطر.' جلست معها مدة. ثم كتبت: 'ما الخطر الذي أديره؟' الإجابة لم تكن الفشل. كانت أن يرى الناس أنني حاولت." },
    { heading: "الممارسة — والانتكاسة", body: "ثلاثة أشهر من قاعدة واحدة: أطلق قبل أن أشعر بالجاهزية. المرة الأولى استغرقت ساعتين لأضغط 'إرسال'. المرة الثالثة استغرقت عشر دقائق. ثم جاء المشروع الكبير — العرض أمام الإدارة — وعدت إلى ثلاثة أسابيع من التعديلات. لكن هذه المرة كنت أعرف ما أفعله. كنت أُدير الخوف، لا أُحسّن الشريحة." },
    { heading: "الآن", body: "تسعة أشهر. آخر شيء أطلقته كان في نسخته السابعة حين أدركت أنني في الأسبوع الثاني من التعديلات على جملة في الشريحة الثالثة. أغلقت الملف وأرسلت. الرد الأول جاء: 'هذا بالضبط ما نحتاجه.' الكمال لا يزال يحضر — لكنني أعرف الآن أنه يُقدّم نفسه كصوت حرص وهو في الواقع صوت خوف." },
  ],
};
